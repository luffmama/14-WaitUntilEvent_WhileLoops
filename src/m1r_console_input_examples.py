...
#        five --> Invalid literal
#      or
#        4.5 Invalid literal
#      or
#        1 1 1 Invalid literal
#      or
#        nothing at all (just press the Enter key) Invalid literal
#      -- try them!) when running the   input_an_integer   example?
#      Put your answer here: Get and invalid literal value error
#
